...
import { Injectable } from '@angular/core'; // Can use DI.
...
import { Quote } from './quote'; // Quote CLASS
...
export class TwainService {
  ...
  private nextId = 1; // For next quote.

  getQuote(): Observable<string> {

// Seems a complicated way of getting a sring!
